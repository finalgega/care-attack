...
public class MySQLController {
	...
	private final String sqlUserID = "CareAttack";	 //	Simply change to the appropriate userID to connect to DB
	private final String sqlPwd = "password";	//	Simply change to the appropriate pwd to connect to the Db
